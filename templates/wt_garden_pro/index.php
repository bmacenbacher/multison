...
<head>
    ...
    $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, animate.min.css, flaticon.css, custom.css') // CSS Files
        ->addJS('bootstrap.min.js, jquery.sticky.js, wow.min.js, main.js,SmoothScroll.js, jquery.countTo.js') // JS Files
