...
function modal(text){
		...
		document.getElementById('inptype').value = text;
}
...
$(document).ready(function($) {
	...
	$('#fastform').submit(function(){
	var msg   = $(this).serialize();
        $.ajax({
          type: 'POST',
          url: 'index.php?set=zakaz',
          data: msg,
          
        });
    yaCounter36048260.reachGoal('zak');    
    $('#fast-ot').html('<img src="images/preloader.gif">	');   
    setTimeout(function() { $('#fast-ot').html('<h5>Заказ принят</h5>	'); }, 1000);     
   ...
   /*-------------------------------------------------*/
	...
	/*	Contact Map
	/* ---------------------------------------------------------------------- */
	var contact = {"lat":"51.671735", "lon":"39.139448"}; //Change a map coordinate here!
